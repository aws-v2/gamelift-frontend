    ...
    <main class="details-content">
      ...
      <template v-else-if="game">
        <section class="details-hero"
          :style="{ backgroundImage: `url(https://picsum.photos/seed/${game.id}/1920/1080)` }">
          <div class="hero-vignette"></div>

          <div class="details-container">
            <div class="poster-sidebar">
              <div class="poster" :style="{ backgroundImage: `url(https://picsum.photos/seed/${game.id}/600/900)` }">
              </div>
            </div>
            ...
            <div class="hero-content">
              ...
              <p class="hero-desc">
                Dive into a vast open world filled with mysteries. Build your character, forge alliances, and shape the
                destiny of the realm. Your journey awaits.
              </p>
...
import { fetchGames } from '@/modules/streaming/services/api'
